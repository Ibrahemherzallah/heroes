        ...
        <section className="relative overflow-hidden">
            <div className="relative h-[240px] sm:h-[300px] md:h-[520px] w-full">
                ...
                {heroSlides.map((slide, index) => (
                    <div key={slide._id} className={`absolute inset-0 transition-opacity duration-700 ${
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-black/10 md:bg-black/15 pointer-events-none" />
