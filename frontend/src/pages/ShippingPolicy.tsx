                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-8 mb-10">
                        ...
                        <ul className="list-disc pr-6 space-y-3 text-gray-600">
                            <li>
                                <strong>نطاق التوصيل:</strong> فلسطين ( الضفة الغربية والقدس والداخل المحتل )،
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-8 mb-10">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            في <span className="font-semibold">Heroess.top</span> نعمل على ضمان رضاكم الكامل،
                            مع العلم أن **الاستبدال** يتم وفق النظام التالي:
                        </p>

                        <ul className="list-disc pr-6 space-y-3 text-gray-600">
                            <li>
                                **الاستبدال متاح فقط بعد الحصول على موافقة الإدارة**، ولا يتم
                                الاستبدال تلقائيًا بدون مراجعة الطلب.
                            </li>
                            <li>
                                يجب أن تكون القطعة **بحالتها الأصلية بالكامل وغير مستخدمة**.
                            </li>
                            <li>
                                لا يوجد استرجاع نقدي، ويقتصر الإجراء على **الاستبدال فقط** بعد الموافقة.
                            </li>
                            <li>
                                في حال وجود عيب مصنعي، يتم معاينة المنتج أولًا، ثم اتخاذ القرار المناسب.
                            </li>
                            <li>
                                يتحمل العميل تكاليف الشحن إلا في حال كان الخطأ من طرفنا.
                            </li>
                        </ul>
                    </div>
                    {/* ================== FAQ ================== */}
